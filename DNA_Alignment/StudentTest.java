...
public class StudentTest {
  ...
  public void myTest(){
    ...
    assertEquals(-1, sa.getScore());
    assertTrue(sa.getResult(0,0).onPath());
    assertTrue(sa.getResult(6,7).onPath());
    SequenceAligner sa2 = new SequenceAligner("ACGT", "ACGA");
    assertEquals("ACGT", sa2.getAlignedX());
    assertEquals("ACGA", sa2.getAlignedY());
  }
